...
export interface RadarVisParams {
  type: 'radar';
  normalize: boolean;
...
function RadarVisOptions({
  stateParams,
  setValue,
}: VisOptionsProps<RadarVisParams>) {
    ...
    <div className="kbn-radar-vis-params">
      ...
      <EuiPanel paddingSize="s">
        <EuiTitle size="xs">
          <h3>
            <FormattedMessage
              id="visTypeRadar.params.radarSettingsSection"
        ...
        <SwitchOption
          label={i18n.translate('visTypeRadar.params.normalize', {
        ...
        <div>
          ...
          <h3>
            <FormattedMessage
              id="visTypeRadar.params.radarVertexSettingsSection"
...
export { RadarVisOptions as default };
